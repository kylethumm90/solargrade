...
INSERT INTO companies (slug, name, category, website, description) VALUES
...
FROM companies WHERE slug = 'sunrun';
...
FROM companies WHERE slug = 'trinity-solar';
...
FROM companies WHERE slug = 'momentum-solar';
...
FROM companies WHERE slug = 'freedom-solar-power';
...
FROM companies WHERE slug = 'palmetto-solar';
...
FROM companies WHERE slug = 'energy-bill-cruncher';
...
FROM companies WHERE slug = 'gohighlevel';
...
FROM companies WHERE slug = 'freedom-forever';
...
FROM companies WHERE slug = 'tesla-solar';
...
FROM companies WHERE slug = 'titan-solar-power';
...
FROM companies WHERE slug = 'lumio';
...
FROM companies WHERE slug = 'venture-solar';
...
FROM companies WHERE slug = 'elevation-solar';
...
FROM companies WHERE slug = 'solcius';
