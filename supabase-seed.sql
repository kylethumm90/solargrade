...
SELECT id, 'Jason M.', 'Independent Sub',
  '{"payReliability":2,"communication":2,"installQuality":3,"warranty":3,"transparency":2,"wouldRecommend":2}'::jsonb,
...
SELECT id, 'Carlos R.', 'SunWorks Electric',
  '{"payReliability":3,"communication":3,"installQuality":3,"warranty":4,"transparency":3,"wouldRecommend":3}'::jsonb,
...
SELECT id, 'Mike D.', 'Northeast Solar Co',
  '{"payReliability":4,"communication":4,"installQuality":4,"warranty":3,"transparency":4,"wouldRecommend":4}'::jsonb,
...
SELECT id, 'Dave P.', 'Patriot Power',
  '{"payReliability":1,"communication":2,"installQuality":3,"warranty":2,"transparency":1,"wouldRecommend":1}'::jsonb,
...
SELECT id, 'Ryan K.', 'Lone Star Electric',
  '{"payReliability":5,"communication":5,"installQuality":5,"warranty":4,"transparency":5,"wouldRecommend":5}'::jsonb,
...
SELECT id, 'Angela S.', 'Green Mountain Installs',
  '{"payReliability":3,"communication":2,"installQuality":3,"warranty":3,"transparency":2,"wouldRecommend":2}'::jsonb,
...
SELECT id, 'Brian T.', 'Solar Pros West',
  '{"payReliability":4,"communication":4,"installQuality":4,"warranty":5,"transparency":4,"wouldRecommend":4}'::jsonb,
...
SELECT id, 'Amanda W.', 'Spark Electric',
  '{"payReliability":3,"communication":1,"installQuality":4,"warranty":3,"transparency":2,"wouldRecommend":2}'::jsonb,
...
SELECT id, 'Greg L.', 'Desert Sun Installs',
  '{"payReliability":1,"communication":1,"installQuality":2,"warranty":1,"transparency":1,"wouldRecommend":1}'::jsonb,
...
SELECT id, 'Tim F.', 'Homeowner',
  '{"payReliability":5,"communication":5,"installQuality":5,"warranty":5,"transparency":5,"wouldRecommend":5}'::jsonb,
...
SELECT id, 'Rachel M.', 'Homeowner',
  '{"payReliability":4,"communication":4,"installQuality":5,"warranty":4,"transparency":3,"wouldRecommend":4}'::jsonb,
