...
export default function SubmitPage() {
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        <div className="bg-[#141820] border border-[#1e2738] rounded-xl p-8">
          ...
          <h2 className="text-2xl font-bold text-[#e2e8f0] mb-2">Company Submitted!</h2>
          <p className="text-[#7a8ba8] mb-6">
            Your submission has been received and will be reviewed by our team.
          </p>
          <a href="/vendors" className="text-amber-500 hover:text-amber-400">
            Browse Vendors
          </a>
        </div>
      </div>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-[#e2e8f0] mb-8">Submit a Company</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label className="block text-sm font-medium text-[#e2e8f0] mb-2">Company Name *</label>
          <input
            type="text"
            value={name}
        ...
        <div>
          <label className="block text-sm font-medium text-[#e2e8f0] mb-2">Website</label>
          <input
            type="url"
            value={website}
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full bg-[#141820] border border-[#1e2738] text-[#e2e8f0] rounded-lg px-4 py-3 min-h-[100px]"
